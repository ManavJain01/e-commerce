      ...
      <label htmlFor={label} className="flex-1 relative flex">
        <Input
          ...
          className={`peer text-2xl w-full border-2 border-blue-400
            ...
            ${inputValue ? "invalid:border-red-400 valid:border-green-400 disabled:border-green-400 disabled:text-gray-400" : ""}
          `}
        />
        ...
        <span
          className={`flex gap-2 absolute top-3 left-4
            ...
            ${inputValue ? "peer-disabled:-top-4 peer-disabled:left-2 peer-disabled:text-green-500 peer-valid:-top-4 peer-valid:left-2 peer-valid:text-green-500 peer-invalid:-top-4 peer-invalid:left-2 peer-invalid:text-red-500" : ""}
          `}
        >
          {label}
          {required
